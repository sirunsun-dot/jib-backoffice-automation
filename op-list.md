- generic [active] [ref=e1]:
          ...
          - generic [ref=e432]:
            - generic [ref=e433]:
              - generic [ref=e434]:
                - text: Operator
                - generic [ref=e435]: "*"
              - button "น้อยกว่าหรือเท่ากับ (≤)" [expanded] [ref=e437] [cursor=pointer]:
  ...
  - dialog [ref=e553]:
    - generic [ref=e554]:
      - img [ref=e555]
      - textbox "ค้นหาตัวเปรียบเทียบ" [ref=e558]
    - generic [ref=e559]:
      - button "น้อยกว่าหรือเท่ากับ (≤)" [ref=e560] [cursor=pointer]:
        - generic [ref=e561]: น้อยกว่าหรือเท่ากับ (≤)
      - button "น้อยกว่า (<)" [ref=e562] [cursor=pointer]:
        - generic [ref=e563]: น้อยกว่า (<)
      - button "มากกว่าหรือเท่ากับ (≥)" [ref=e564] [cursor=pointer]:
        - generic [ref=e565]: มากกว่าหรือเท่ากับ (≥)
      - button "มากกว่า (>)" [ref=e566] [cursor=pointer]:
        - generic [ref=e567]: มากกว่า (>)
      - button "เท่ากับ (=)" [ref=e568] [cursor=pointer]:
        - generic [ref=e569]: เท่ากับ (=)
      - button "ไม่เท่ากับ (≠)" [ref=e570] [cursor=pointer]:
        - generic [ref=e571]: ไม่เท่ากับ (≠)
      - button "อยู่ในรายการ" [ref=e572] [cursor=pointer]:
        - generic [ref=e573]: อยู่ในรายการ
      - button "ไม่อยู่ในรายการ" [ref=e574] [cursor=pointer]:
        - generic [ref=e575]: ไม่อยู่ในรายการ
      - button "ต้องเลือกคู่กัน" [ref=e576] [cursor=pointer]:
        - generic [ref=e577]: ต้องเลือกคู่กัน
      - button "ห้ามเลือกคู่กัน" [ref=e578] [cursor=pointer]:
        - generic [ref=e579]: ห้ามเลือกคู่กัน